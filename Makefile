...
dist:
	...
	cp -f  bin/Postmodular.vst3/Contents/x86_64-win/Postmodular.vst3 "$(DIST_DIR)/vst3/"
	cp -rL bin/Postmodular.vst3/Contents/Resources/.              "$(DIST_DIR)/resources/"
	cp -f  bin/Cardinal.clap/PostmodularFX.clap                   "$(DIST_DIR)/clap/"
	cp -f  bin/Cardinal.clap/PostmodularSynth.clap                "$(DIST_DIR)/clap/"
